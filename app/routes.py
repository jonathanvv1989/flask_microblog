...
def before_request():
    if current_user.is_authenticated:
        current_user.last_seen = datetime.utcnow()  # auto add user to session
        db.session.commit()
...
def edit_profile():
    ...
    if form.validate_on_submit():
        # Commit amended user information to db
        ...
        # Initial form display, pre-populate existing information
